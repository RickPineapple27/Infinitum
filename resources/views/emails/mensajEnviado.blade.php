                                        ...
                                        <table>
                                            <tr style="border-collapse:collapse">
                                                <td valign="top" align="center">
                                                    <table >
                                                        <tr style="border-collapse:collapse">
                                                            <td><p style="text-align: center" >Se han enviado datos para una contratacion, favor de atender las necesidades del cliente</p></td>
                                                        </tr>
                                                        <tr style="border-collapse:collapse">
                                                            <td >
                                                                <table >
                                ...
                                <tr style="border-collapse:collapse">
                                    <td align="left" style="padding:0;Margin:0">
                                        <table width="100%" cellspacing="0" cellpadding="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                            <tr style="border-collapse:collapse">
                                                <td valign="top" align="center" style="padding:0;Margin:0;width:600px">
                                                    <table style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:separate;border-spacing:0px;background-color:#fefbf7;border-radius:4px" width="100%" cellspacing="0" cellpadding="0" bgcolor="#fefbf7" role="presentation">
                                                        <tr style="border-collapse:collapse">
                                                            <td align="center" style="padding:0;Margin:0"><span class="es-button-border" style="border-style:solid;border-color:#fefdfc;background:#6abff4;border-width:0px;display:block;border-radius:24px;width:auto"><a href="" class="es-button" target="_blank" style="mso-style-priority:100 !important;text-decoration:none;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;color:#FFFFFF;font-size:20px;border-style:solid;border-color:#6abff4;border-width:15px 25px 15px 25px;display:block;background:#6abff4;border-radius:24px;font-family:verdana, geneva, sans-serif;font-weight:normal;font-style:normal;line-height:24px;width:auto;text-align:center;border-left-width:5px;border-right-width:5px">Descargar en excel</a></span></td>
                                                        </tr>
                                                    </table></td>
                                            </tr>
                                        </table></td>
